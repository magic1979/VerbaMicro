...
//        logout();
    ...
    function api(obj) {
        ...
        //url = 'https://graph.facebook.com/v2.5' + obj.path + '?fields=id,name,email' + toQueryString(params);
			  
		//url = 'https://graph.facebook.com/v.2.5' + obj.path + '?' +"fields="+ fields +"&access_token="+ tokenStore.fbAccessToken;
